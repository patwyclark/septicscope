...
<h2>Pumping checklist</h2><ul class="checks"><li>Confirm which tank compartments will be pumped and whether locating or excavation is included.</li><li>Ask whether filter cleaning or inspection is included or separately priced.</li><li>Keep the pumping receipt and service notes.</li><li>Record any sludge/scum measurements and the next recommended inspection date.</li><li>Compare contractor quotes using the same service scope. If tank size is unknown, the <a href="/guides/septic-tank-size-calculator/">jurisdiction-aware septic tank size planning guide</a> can help you identify questions to verify against local records.</li></ul>
<h2>Do not use the calendar as a diagnosis</h2><p>A routine maintenance interval is not a substitute for troubleshooting symptoms. If sewage is backing up, multiple drains are slow, the yard smells like sewage, the drainfield is wet or an alarm is active, arrange appropriate professional diagnosis. Pumping may be part of the response, but it does not repair every drainfield, pipe, pump or distribution problem. If the soil treatment area is the concern, review the <a href="/guides/septic-drainfield-repair-replacement/">drainfield repair vs. replacement guide</a>.</p>
<h2>When you buy or sell a home</h2><p>Do not rely only on the seller's recollection of maintenance. Obtain permits, design records, pumping history and a transaction-appropriate septic inspection. Transfer requirements vary by jurisdiction, so use the <a href="/guides/">SepticScope homeowner guides</a> together with the <a href="/counties/">local county directory</a>.</p>
