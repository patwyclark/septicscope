...
<p>For routine service planning, use the <a href="/guides/septic-maintenance-checklist/">septic maintenance checklist</a>. If the soil treatment area is failing or under evaluation, the <a href="/guides/septic-drainfield-repair-replacement/">drainfield repair vs. replacement guide</a> explains why system type and site conditions can materially change the scope of work.</p>
<h2>Buying a home? Verify the system, not just the listing</h2>
<p>Real-estate listings may say only “septic,” which is not enough to understand the equipment or future obligations. Request the permit, as-built drawing, maintenance history and latest inspection. Then compare the approved design with what is actually on the property. Use the <a href="/guides/">SepticScope homeowner guides</a> and the local county page for transaction-specific due diligence and records contacts.</p>
