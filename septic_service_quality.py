...
def repair_homepage_links() -> None:
    ...
    if "/faq/how-do-i-find-my-septic-system-records/" in text:
...
def verify_hidden() -> None:
    ...
    if "data-county-lookup-root" not in counties or "FIPS 48121" not in counties:
